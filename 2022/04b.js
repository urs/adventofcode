...
rl.on('close', () => {
  ...
  // Filter only pairs where 1st range ends after 2nd range start
  pairs = pairs.filter(pair => pair[0][1] >= pair[1][0])
  console.debug("Filter only pairs where 1st range ends after 2nd range start", pairs)
